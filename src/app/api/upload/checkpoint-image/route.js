...
export async function POST(request) {
  try {
    ...
    const uniqueFilename = `checkpoint_${timestamp}_${randomNum}${fileExtension}.enc`; // Add .enc extension
    
    // Create directory if it doesn't exist
    const uploadDir = path.join(process.cwd(), 'dam', 'checkpoints');
    ...
    const imageUrl = `/dam/checkpoints/${uniqueFilename}`;
