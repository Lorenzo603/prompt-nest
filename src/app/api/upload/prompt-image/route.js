...
export async function POST(request) {
  try {
    ...
    const uniqueFilename = `prompt_${timestamp}_${randomNum}${fileExtension}.enc`; // Add .enc extension
    
    // Create directory if it doesn't exist
    const uploadDir = path.join(process.cwd(), 'dam', 'prompts');
    ...
    const imageUrl = `/dam/prompts/${uniqueFilename}`;
