      ...
      <div className="mb-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200 font-medium cursor-pointer"
          >
            {loading ? (
